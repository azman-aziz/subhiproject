			...
			<div class="border-color info-footer">
				...
				<div class="mx-auto d-flex flex-column flex-lg-row align-items-center footer-info-space gap-4">
					...
					<nav class="mx-auto d-flex flex-wrap align-items-center justify-content-center gap-4">
						<a href="https://storyset.com" class="footer-link" style="text-decoration: none">IllustrasionbyStoryset</a>
						<span>|</span>
						<a href="https://elements.buildwithangga.com/" class="footer-link" style="text-decoration: none">Propertybybuildwithangga</a>
						<span>|</span>
						
					</nav>
					<nav class="d-flex flex-lg-row flex-column align-items-center justify-content-center">
						<p style="margin: 0"><a href="https://instagram.com/azman_id" class="footer-link" style="text-decoration: none">Copyright © 2021  || Azman</a></p>
					</nav>
				</div>
			</div>
		</div>
